...
if DATABASE_URL and DATABASE_URL.startswith("postgres://"):
    ...
    config.set_section_option("alembic", "DB_HOST", DB_HOST)
    config.set_section_option("alembic", "DB_PORT", DB_PORT)
    config.set_section_option("alembic", "DB_NAME", DB_NAME)
    config.set_section_option("alembic", "DB_USER", DB_USER)
    config.set_section_option("alembic", "DB_PASSWORD", DB_PASSWORD)
